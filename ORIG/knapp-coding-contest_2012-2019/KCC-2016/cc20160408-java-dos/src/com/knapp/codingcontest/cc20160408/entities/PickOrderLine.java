...
public class PickOrderLine {
  ...
  public PickOrderLine(final String[] dataAsArray) {
    ...
    Contract.requires(!Contract.isNullOrWhiteSpace(dataAsArray[1]), "productCode required but is null or whitespace only");
    Contract.requires(!Contract.isNullOrWhiteSpace(dataAsArray[2]), "quantity required but is null or whitespace only");
