...
import com.knapp.codingcontest.cc20160408.util.PrepareUpload;
import com.knapp.codingcontest.cc20160408.util.ResultWriter;
import com.knapp.codingcontest.cc20160408.util.Scheduler;
import com.knapp.codingcontest.cc20160408.util.Strings;
...
public final class Program {
  ...
  public static void main(final String... args) {
    ...
    try {
      ...
      final Scheduler scheduler = new Scheduler(input.getProductCollection(), input.getPickOrderCollection(),
   ...
   */
  private static void writeProperties(final Solution solution, final String outFilename) throws Exception {
