...
public final class CsvReader {
   ...
   * @throws Exception
   */
  public static <T extends Object> List<T> readCsvFile(final String fullFileName, final Class<T> type) throws Exception {
    ...
    if (null == ctor) {
      throw new IllegalArgumentException(String.format(
          "Target '%s' can not be constructed because it does not contain a ctor with string [] as argument", type.getName()));
    }
