...
public class Input {
   ...
   * @throws Exception
   */
  public static Input createFromCsv() throws Exception {
    ...
    input.pickOrderCollection = PickOrderCollection.createFromCsv(Settings.dataPath + File.separator + "pickorders.csv");
    return input;
  }
