 ...
 */
public class Solution_funnybackup {
  ...
  public Solution_funnybackup(final Warehouse warehouse, final InputData input) {
  ...
  public void run() throws Exception {
    ...
    while (!allOrders.isEmpty()) {
      ...
      List<Order> overlap = EXACToverlap(new HashSet<>(current.getAllProducts()), allOrders);
      for (Order o : overlap) {
        try {
