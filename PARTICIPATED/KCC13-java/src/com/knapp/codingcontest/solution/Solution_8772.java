...
public class Solution_8772 {
  ...
  public Solution_8772(final WarehouseInternal iwarehouse, final InputDataInternal iinput) {
  ...
  public void run() throws Exception {
    ...
    while (!orders.isEmpty()) {
      ...
      while (!open_products.isEmpty()) {
        currentProduct = findClosestProduct(open_products, product_shelf_map, warehouse.getCurrentPosition());
